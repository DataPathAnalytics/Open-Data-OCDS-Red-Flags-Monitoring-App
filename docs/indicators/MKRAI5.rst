...
1. Если в конкурсе отсутствует блок ``data.data.conditionOfContract``, если в нем нет вложений или все вложения равны ``0``, индикатор принимает значение ``1``. В противном случае, индикатор принимает значение ``0``. 
